...
import 'package:healthcare_management_system/screens/messages/components/chat_input_field.dart';
      ...
      child: Align(
        ...
        child: Container(
          ...
          decoration: BoxDecoration(
            color: Config.secondaryColor.withOpacity(0.2),
          ...
          child: Column(
            crossAxisAlignment: message.isSender
                ...
                : CrossAxisAlignment
                    .start, // Align received messages to the left
            children: [
              Text(message.text),
